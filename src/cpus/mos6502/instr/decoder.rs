...
pub fn decode<R>(reader: &mut R) -> Result<Instruction> where R: io::Read {
    ...
    let instr = match opcode {
        ...
        0x0B => Instruction::ANC(try!(read_imm(reader))),
        0x0C => Instruction::IGN(try!(read_abs(reader))),
        ...
        0x1C => Instruction::IGN(try!(read_abs_x(reader))),
        ...
        0x2B => Instruction::ANC(try!(read_imm(reader))),
        ...
        0x3C => Instruction::IGN(try!(read_abs_x(reader))),
        ...
        0x5C => Instruction::IGN(try!(read_abs_x(reader))),
        ...
        0x7C => Instruction::IGN(try!(read_abs_x(reader))),
        ...
        0xDC => Instruction::IGN(try!(read_abs_x(reader))),
        ...
        0xEB => Instruction::SBC(try!(read_imm(reader))),
        ...
        0xFC => Instruction::IGN(try!(read_abs_x(reader))),
